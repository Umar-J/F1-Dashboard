                ...
                >
                  ...
                  >
                    ...
                    <h2 className="text-2xl item2country">
                      {new Date(weekend.Events[0].Start).toLocaleDateString(
                        "en-US",
                        { month: "long" }
                      ) + " "}
                    </h2>
                  ...
                  <hr
                    style={{ width: "500px", textAlign: "left", marginLeft: 0 }}
                  />
                  <div
                    className="weekend-container"
                    style={{ maxWidth: "500px" }}
                  >
                    <p
                    ...
                    <p className="saturday-header">
                      {new Date(weekend.Events[2].Start).toLocaleDateString(
                        "en-US",
                        { weekday: "long" }
                      )}
                    </p>
